          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <Link href={`/profile/${tweet.user?.username}`}>
                <span className="font-medium hover:text-primary transition-colors text-foreground hover:underline">
                  {tweet.user?.fullName}
                </span>
                </Link>
                <Link href={`/profile/${tweet.user?.username}`}>
              ...
              {gridImages.length > 0 && <ImageGrid images={gridImages} className="mt-3" />}
